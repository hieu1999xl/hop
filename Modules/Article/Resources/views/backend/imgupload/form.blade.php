<div class="row">
    <div class="col-12 col-md-12">
        <div class="form-group">
            ...
            {{ html()->textarea($field_name)->placeholder($field_placeholder)->class('form-control')->attributes(["$required"])->value($$module_name_singular->title) }}
        </div>
    </div>
    <div class="col-12 col-md-12">
        <div class="form-group">
            ...
            ?>
            {{ html()->label($field_lable, $field_name) }} {!! fielf_required($required) !!}
            {{ html()->textarea($field_name)->placeholder($field_placeholder)->class('form-control')->attributes(["$required"])->value($$module_name_singular->sub_title) }}
        </div>
    </div>
    <div class="col-12 col-md-12">
        <div class="form-group">
            ...
            ?>
            {{ html()->label($field_lable, $field_name) }} {!! fielf_required($required) !!}
            {{ html()->select($field_name, $select_options, $$module_name_singular->oder)->placeholder($field_placeholder)->class('form-control select2')->attributes(["$required"]) }}
        </div>
    </div>
</div>
<div class="row">
    <div class="col-10">
        <div class="form-group">
            ...
            $select_options = [
                ...
                // route('frontend.services_product') => 'services/product-consultantcy-development',
                ...
                route('frontend.contact_us') => 'contact-us',
                route('frontend.submit_email')=> 'thank-you',
                route('frontend.search_result') => 'result',
            ];
            ?>
            {{ html()->label($field_lable, $field_name) }} {!! fielf_required($required) !!}
            {{ html()->select($field_name, $select_options, $$module_name_singular->link_button)->placeholder($field_placeholder)->class('form-control select2 col-md-4') }}
        </div>
    </div>
    <div class="col-2">
        <div class="form-group">
        <?php
            ...
            ?>
            {{ html()->label($field_lable, $field_name) }} {!! fielf_required($required) !!}
            {{ html()->select($field_name, $select_options, $$module_name_singular->type)->placeholder($field_placeholder)->class('form-control select2')->attributes(["$required"]) }}
        </div>
    </div>
</div>
<div class="row">
