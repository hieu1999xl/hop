...
class CreateSiteMap extends Command
{
  ...
  public function handle()
  {
    ...
    // add landing page
    $sitemap->add("https://qa.hop.vn/", Carbon::now(), '0.8', 'daily');
    $sitemap->add("https://edu.hop.vn", Carbon::now(), '0.8', 'daily');
    $sitemap->add("https://blockchain.hop.vn", Carbon::now(), '0.8', 'daily');
    $sitemap->add("https://datascience.hop.vn/", Carbon::now(), '0.8', 'daily');
    $sitemap->add("https://ecommerce.hop.vn/", Carbon::now(), '0.8', 'daily');
    foreach ($languages as $language => $value) {
      // service
      ...
      $sitemap->add($baseURL . '/' . $language . '/contact-us', Carbon::now(), '0.8', 'daily');
      // case-studies
