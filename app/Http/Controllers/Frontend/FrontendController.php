...
class FrontendController extends Controller
{
    ...
    public function index()
    {
        ...
        $bannerBottom=[
            'display'=>false,
            'class'=>'banner_bottom--index bTech section_block home_page--banner',
            ...
            'image'=>asset('frontend/assets/images/tech_screen/bgmid3.jpg'),
            'imageMobile'=>asset('frontend/assets/images/tech_screen/bgmid3.jpg'),
    ...
    public function sendMail(Request $request)
    {
        ...
        return back()->with('msg', 'We have received contact. Thank you!');
    }
