...
class ServiceController extends FrontendController
{
    ...
    public function services_maintain()
    {
        ...
        $meta = [
            'pType' => 'website',
            'nDescription' => trans('frontend.ogDescription'),
            'pTitle' => trans('frontend.HOPOffshore'),
            'pUrl' => url()->current(),
            'pDescription' => trans('frontend.ogDescription'),
            'pImage' => asset('frontend/assets/images/section_1/logo.webp'),
    ...
    public function outsourcing_services()
    {
        ...
        return view(
            'frontend.services.outsourcing_services',
            compact(
                'body_class',
                'items_services',
                'items_inovation',
    ...
    public function services_legacy()
    {
        ...
        return view('frontend.services.legacy', compact(
            'body_class',
            "module_name_singular",
            "dataStudiesCase",
            'breadcrumbs',
    ...
    public function services_enterprise()
    {
        ...
        $dataStudiesCase = $this->getCaseStudiesBySlug($slug);
        $breadcrumbs = $this->getBreadcrumbServicesChildLevel3($slug);
        $styles = $this->getStylesView(trans('services.Custom Software Development'), 'pEnterprise');
        $flagMeta = false;
        $filterServices = $this->getTagsMenus(MenuConstants::MENU_SERVICES);
        $filterTechnologies = $this->getTagsMenus(MenuConstants::MENU_TECHNOLOGIES);
        $filterIndustries = $this->getTagsMenus(MenuConstants::MENU_INDUSTRIES);
        ...
        $meta = [
            ...
            'pDescription' => trans('frontend.ogDescription'),
            'pImage' => asset('frontend/assets/images/section_1/logo.webp'),
            'nKeywords' => trans('services.Custom Software Development keyword'),
            'nAnalytics' => setting('google_analytics'),
            'linkRel' => url()->full(),
        ];
        ...
        $banner = [
            'display' => true,
            'class' => 'section_banner_top',
            'title' => trans('services.Custom Software Development'),
            'classTitle' => 'font_weight_700 title_banner',
            'displayDecription' => false,
            'classDecription' => 'description_banner',
            'description' => trans('services.Custom Software Development'),
            'displayButon' => false,
            ...
            'altImage' => trans('services.Custom Software Development'),
        ];
        $bannerBottom = [
            'display' => true,
            'class' => 'section_launch_your_product',
    ...
    public function digital_transformation()
    {
        ...
        $dataStudiesCase = $this->getCaseStudiesBySlug($slug);
        $breadcrumbs = $this->getBreadcrumbServicesChildLevel3($slug);
        $styles = $this->getStylesView(trans('frontend.Digital Transformation'), 'pDigital');
        $flagMeta = false;
        $filterServices = $this->getTagsMenus(MenuConstants::MENU_SERVICES);
        $filterTechnologies = $this->getTagsMenus(MenuConstants::MENU_TECHNOLOGIES);
        $filterIndustries = $this->getTagsMenus(MenuConstants::MENU_INDUSTRIES);
        $meta = [
            ...
            'pDescription' => trans('frontend.ogDescription'),
            'pImage' => asset('frontend/assets/images/section_1/logo.webp'),
            'nKeywords' => trans('services.Digital Transformation keyword'),
            'nAnalytics' => setting('google_analytics'),
            'linkRel' => url()->full(),
        ];
        $banner = [
            'display' => true,
            'class' => 'section_banner_top',
            'title' => trans('services.Digital Transformation'),
            'classTitle' => 'font_weight_700 title_banner',
            'displayDecription' => false,
            'classDecription' => 'description_banner',
            'description' => trans('frontend.Digital Transformation'),
            'displayButonContactUs' => false,
            'image' => asset('frontend/assets/images/banners/digital_transformation.webp'),
            'imageMobile' => asset('frontend/assets/images/banners/digital_transformation.webp'),
            'altImage' => trans('frontend.Digital Transformation'),
        ];
        $bannerBottom = [
            'display' => true,
            'class' => 'section_launch_your_product',
        ...
        return view('frontend.services.digital_transformation', compact(
            'body_class',
            "module_name_singular",
            "dataStudiesCase",
            'breadcrumbs',
    ...
    public function telecommunications()
    {
        ...
        $module_name_singular = Str::singular($module_name);
        $breadcrumbs = $this->getBreadcrumbServicesChildLevel3($slug);
        $styles = $this->getStylesView(trans('services.Telecomunication'), 'pTelecomunication');
        $flagMeta = false;
        $filterServices = $this->getTagsMenus(MenuConstants::MENU_SERVICES);
        $filterTechnologies = $this->getTagsMenus(MenuConstants::MENU_TECHNOLOGIES);
        $filterIndustries = $this->getTagsMenus(MenuConstants::MENU_INDUSTRIES);
        $meta = [
            ...
            'pDescription' => trans('frontend.ogDescription'),
            'pImage' => asset('frontend/assets/images/section_1/logo.webp'),
            'nKeywords' => trans('services.Telecomunication keyword'),
            'nAnalytics' => setting('google_analytics'),
            'linkRel' => url()->full(),
        ];
        $banner = [
            'display' => true,
            'class' => 'section_banner_top',
            'title' => trans('services.Telecommunications service provision'),
            'classTitle' => 'font_weight_700 title_banner',
            'displayDecription' => false,
            'classDecription' => 'description_banner',
            'description' => trans('services.Telecommunications service provision'),
            'displayButonContactUs' => false,
            'image' => asset('frontend/assets/images/banners/telecommunications.webp'),
            'imageMobile' => asset('frontend/assets/images/banners/telecommunications.webp'),
            'altImage' => trans('services.Telecommunications service provision'),
        ];
        $bannerBottom = [
            'display' => true,
            'class' => 'section_launch_your_product',
        ...
        return view('frontend.services.telecommunications', compact(
            'body_class',
            "module_name_singular",
            "dataStudiesCase",
            'breadcrumbs',
    ...
    public function web_advertising_agency()
    {
        $body_class = '';
        $slug = $this->getSlugByUrl($_SERVER['REQUEST_URI']);
        $dataStudiesCase = $this->getCaseStudiesBySlug($slug);
        ...
        $module_name_singular = Str::singular($module_name);
        $breadcrumbs = $this->getBreadcrumbServicesChildLevel3($slug);
        $styles = $this->getStylesView(trans('frontend.Web advertising agency'), 'pWebAdvertisingAgency');
        $flagMeta = false;
        $filterServices = $this->getTagsMenus(MenuConstants::MENU_SERVICES);
        $filterTechnologies = $this->getTagsMenus(MenuConstants::MENU_TECHNOLOGIES);
        $filterIndustries = $this->getTagsMenus(MenuConstants::MENU_INDUSTRIES);
        $meta = [
            ...
            'pDescription' => trans('frontend.ogDescription'),
            'pImage' => asset('frontend/assets/images/section_1/logo.webp'),
            'nKeywords' => trans('frontend.Web advertising agency keyword'),
            'nAnalytics' => setting('google_analytics'),
            'linkRel' => url()->full(),
        ];
        $banner = [
            'display' => true,
            'class' => 'section_banner_top',
            'title' => trans('services.Web advertising agency'),
            'classTitle' => 'font_weight_700 title_banner',
            'displayDecription' => false,
            'classDecription' => 'description_banner',
            'description' => trans('services.Web advertising agency'),
            'displayButonContactUs' => false,
            'image' => asset('frontend/assets/images/banners/web_advertising_agency.webp'),
            'imageMobile' => asset('frontend/assets/images/banners/web_advertising_agency.webp'),
            'altImage' => trans('services.Web advertising agency'),
        ];
        $bannerBottom = [
            'display' => true,
            'class' => 'section_launch_your_product',
        ...
        return view('frontend.services.web_advertising_agency', compact(
            'body_class',
            "module_name_singular",
            "dataStudiesCase",
            'breadcrumbs',
    ...
    public function customer_service()
    {
        ...
        $module_name_singular = Str::singular($module_name);
        $breadcrumbs = $this->getBreadcrumbServicesChildLevel3($slug);
        $styles = $this->getStylesView(trans('services.Customer Service'), 'pCustomerService');
        $flagMeta = false;
        $filterServices = $this->getTagsMenus(MenuConstants::MENU_SERVICES);
        $filterTechnologies = $this->getTagsMenus(MenuConstants::MENU_TECHNOLOGIES);
        $filterIndustries = $this->getTagsMenus(MenuConstants::MENU_INDUSTRIES);
        $meta = [
            ...
            'pDescription' => trans('frontend.ogDescription'),
            'pImage' => asset('frontend/assets/images/section_1/logo.webp'),
            'nKeywords' => trans('frontend.Customer Service keyword'),
            'nAnalytics' => setting('google_analytics'),
            'linkRel' => url()->full(),
        ];
        $banner = [
            'display' => true,
            'class' => 'section_banner_top',
            'title' => trans('services.Customer Service'),
            'classTitle' => 'font_weight_700 title_banner',
            'displayDecription' => false,
            'classDecription' => 'description_banner',
            'description' => trans('services.Customer Service'),
            'displayButonContactUs' => false,
            'image' => asset('frontend/assets/images/banners/customer_service.webp'),
            'imageMobile' => asset('frontend/assets/images/banners/customer_service.webp'),
            'altImage' => trans('frontend.Customer Service'),
        ];
        $bannerBottom = [
            'display' => true,
            'class' => 'section_launch_your_product',
        ...
        return view('frontend.services.customer_service', compact(
            'body_class',
            "module_name_singular",
            "dataStudiesCase",
            'breadcrumbs',
