$(".owl-carousel").owlCarousel({
    loop: true,
        ...
        viewportFraction: 1,
        navText: [
            "<img class='img_owl' src='./images/prev.webp' alt='prev'>",
            "<img class='img_owl' src='./images/next.webp' alt='next'>",
        ],
        autoplay: true,
...
$(".owl_carousel-project").owlCarousel({
    loop: true,
    margin: 10,
    nav: false,
    viewportFraction: 1,
    navText: [
        "<img class='img_owl' src='./images/prev.png'>",
        "<img class='img_owl' src='./images/next.png'>",
    ],
    autoplay: true,
    autoplayHoverPause: true,
    responsive: {
...
async function userCreateModal() {
    ...
    if (validateFormModal() && !specialFormat.test(full_name) && !specialFormatCompany.test(company) && company!== '' && full_name !== '' ) {
        ...
        xhttp.open("POST", "https://hop.vn/api/contact");
