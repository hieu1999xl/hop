        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <form action="submit" style="width=100%" id="">
                    ...
                    <textarea name="message" style="height:200px" rows="30">Write something here...</textarea>
                </form>
