...
@section('title') {{trans('frontend.HOPTvj')}} @endsection
@push('after-styles')
            ...
            <div class="box_content">
               ...
               <caption>{{trans('frontend.factsheet')}}</caption>
                  ...
                  <tr>
                     ...
                     <td><a href="https://hop.vn/ja/about-us/tvj" target="_blank">https://hop.vn/ja/about-us/tvj </a> <br> </td>
                  </tr>
                  <tr>
                     <td class="sub_title  font_weight_700" >{{trans('frontend.facesheetleft8')}}</td>
                     <td><a href="mailto:mkt_tvo@gmail.com" >hop@gmail.vn</a>
                     </td>
                  </tr>
                  <tr>
