    ...
    <div class="container">
        <div class="row footer_pc">
            <div class="col-3 space">
                ...
                <p><a href="mailto:hop@gmail.vn">hop@gmail.vn</a></p>
            </div>
            <div class="col-3 space">
                ...
                <p><a href="mailto:hcm@gmail.com">hcm@gmail.vn</a></p>
            </div>
            <div class="col-3 space">
            ...
            <div class="col-3 right_footer">
                ...
                <div class="row">
                    ...
                    if ($item->name == 'Industries' || $item->name == 'Services' || $item->name == 'About Us') {
                    $url = '#';
                    }
                    else {
                    $url = '/'.$item->slug;
