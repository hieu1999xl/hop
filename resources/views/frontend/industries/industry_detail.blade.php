...
@section('title'){{trans('frontend.HOPSoftware')}}{{$meta['pTitle']}}  @endsection
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="content-editor">
                        ...
                        <a href="https://edu.hop.vn/" target="_blank" class="twok__button">
                            <div class="button__text">
                                <p class="explore">{{trans('frontend.More Info')}}</p>
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="content-editor">
                        ...
                        <a href="https://ecommerce.hop.vn/" target="_blank" class="twok__button">
                            <div class="button__text">
                                <p class="explore">{{trans('frontend.More Info')}}</p>
