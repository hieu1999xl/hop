...
<head>
    ...
    <title>
        {{$$module_name_singular->dataLocale->meta_title==''?$$module_name_singular->dataLocale->title:$$module_name_singular->dataLocale->meta_title}}
    </title>
    @include('frontend.includes.detailPage')
...
<body>
    ...
    <div class="container-fluid social_talk">
        <nav class="social">
            <ul>
                <li id="fb"><a href="#" target="_blank" rel="noopener noreferrer">Facebook <i class="fab fa-facebook-f"></i></a></li>
                <li id="link"><a href="#" target="_blank" rel="noopener noreferrer">Linkedin<i class="fab fa-linkedin-in"></i></a></li>
                <li id="email"><a href="mailto:hotro@human-life.vn">E-mail <i class="fas fa-envelope"></i></a></li>
            </ul>
        </nav>
    </div>
