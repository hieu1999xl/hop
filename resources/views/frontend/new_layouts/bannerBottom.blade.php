    ...
    <div class="container section_banner">
        <div class="row section_banner--row">
            ...
            <div class="col-12 study-more text-center">
                <label class="banner_btn btn-round-lg btn-white">
                    <span><a href="{{ route('frontend.contact_us') }}">{{$button}}</a>+</span>
                </label>
            </div>
        </div>
    </div>
...
<section class="{{$class}}">
    ...
    <div class="container banner_content">
        <div class="row">
            <div class="col-12">
                <p class="block_spacing_md text-center section_page--subtitle text-white">{{trans('frontend.weserveyou')}}</p>
