...
@section('title') {{trans('frontend.HOPOnsite')}} @endsection
@push ('after-styles')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12">
                <img class="img-why-pc" src="{{ asset('frontend/assets/images/service-detail/onsiteresource.jpg')}}" alt="{{trans('frontend.Onsite Resources')}}">
            </div>
            <div class="col-md-6 col-sm-12 col-xs-12">
                <h2 class="font_weight_700 page_title text_margin text-dark">
                    {{trans('frontend.Onsite Resources')}}
                </h2>
                <p class="text_margin">{{trans('frontend.Onsite Resources infor')}}
            </div>
        </div>
    </div>
</section>
