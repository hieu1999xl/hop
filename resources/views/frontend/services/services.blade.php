...
@section('title'){{trans('frontend.HOPServices')}} @endsection
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content-left ">
                        ...
                        <img src="{{ asset('frontend/assets/images/server/mobile-app.webp')}}" alt="products & services">
                        <p>HOP always updates itself by making use of cutting – edge technologies to mobilize enterprise
                            ...
                            to extend the capabilities of existing so as to cross multi platforms? HOP’s mobile
