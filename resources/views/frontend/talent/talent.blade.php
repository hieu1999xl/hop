...
@section('title') {{trans('frontend.HOPTalent')}} @endsection
@push('after-styles')
...
<section class="section_block talent_page">
            ...
            <div class="col-4">
                ...
                <div class="select_position">
                    ...
                    <ul>
                        ...
                        @endphp
                        <li id="myTable" class="text_margin"><a class="talent_title_filter font_weight_600" href="{{ route('frontend.talent') }}/{{$job->id}}/{{$job->slug}}">{{$jobName}}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
    ...
    <div class="container talent_filter_mobile">
        <div class="row justify-content-center">
            <!-- <div class="col-12 talent_form-group text_margin">
...
<script type="text/javascript">
    ...
    function generateHtmlPc(data, defaultLang) {
        $('#list-data').empty();
        const changeLangjobs = ["jobs Opening", "các vị trí tuyển dụng", "求人情報"]
        const jobTitle = defaultLang === 'vi'
            ? changeLangjobs[1]
            : defaultLang === 'ja'
                ? changeLangjobs[2]
                : changeLangjobs[0];
        const titleOpen = $(`<h2 class="font_weight_700 page_title text_color_default">${data.length} ${jobTitle}</h2>`);
                    ...
                    <div class="col-4 talent_desktop_apply">
                        <div>
                            <a class="btn-round btn-purple font_weight_400"  href='${urlDetails}' id="btn">
                                ${defaultLang === 'vi' ? 'Ứng tuyển' : defaultLang === 'en' ? 'Apply now' : '今すぐ応募'}
                            </a>
                            ${dateExpired}
                        </div>
                    </div>
    ...
    //generate html in screen mobile
