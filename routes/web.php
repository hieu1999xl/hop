...
Route::group([
	...
	Route::group(['middleware' => 'htmlMin'], function () {
		...
		Route::group(['prefix' => 'services', 'middleware' => 'activeMenu'], function () {
			...
			Route::get('/digital-transformation', 'ServiceController@digital_transformation')->name('digital_transformation');
			Route::get('/telecommunications-service-provision', 'ServiceController@telecommunications')->name('telecommunications');
			Route::get('/web-advertising-agency', 'ServiceController@web_advertising_agency')->name('web_advertising_agency');
			Route::get('/customer-service', 'ServiceController@customer_service')->name('customer_service');
		});
		...
		Route::get('contact-us', 'AboutController@contact_us')->name('contact_us');
